...
1. [Participant Document Pack](#1-participant-document-pack)
2. [What Teams Need to Build](#2-what-teams-need-to-build)
3. [Available Resources](#3-available-resources)
4. [Suggested Team Role Split](#4-suggested-team-role-split)
5. [API Submission Rule](#5-api-submission-rule)
6. [Deployment Options](#6-deployment-options)
7. [Deploying on Poridhi Lab / VM / AWS](#7-deploying-on-poridhi-lab--vm--aws)
8. [Docker Fallback Rules](#8-docker-fallback-rules)
9. [AI and Model Usage Policy](#9-ai-and-model-usage-policy)
10. [Secrets and Environment Variables](#10-secrets-and-environment-variables)
11. [Repository Access Policy](#11-repository-access-policy)
12. [Testing Checklist Before Submission](#12-testing-checklist-before-submission)
13. [Submission Form Checklist](#13-submission-form-checklist)
14. [What Not to Do](#14-what-not-to-do)
15. [Common Troubleshooting](#15-common-troubleshooting)
16. [Final Pre-Submit Checklist](#16-final-pre-submit-checklist)
...
**Repository example** (placeholders only, safe to commit):
...
**Private judging secret example** (only if required for Docker/code fallback — never committed):
